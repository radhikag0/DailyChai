...
import { Pencil } from 'lucide-react'; // Added based on the final screenshot
                ...
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form className='space-y-4' onSubmit={handleSaveProfile}>
                            ...
                            <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <div className='group/profile relative'>
                                    <img 
                                        ...
                                        alt="" 
                                        className='w-80 h-40 md:h-56 rounded-lg bg-gradient-to-r from-indigo-200
                        ...
                        <div>
                            ...
                            <input 
                                type="text" 
                                className='w-full p-3 border border-gray-200 rounded-lg mb-1' 
                        ...
                        <div className='flex justify-end space-x-3 pt-6'>
                            ...
                            hover:from-indigo-600 hover:to-purple-700 transition text-white rounded-lg cursor-pointer'>
                                Save changes
                            </button>
                        </div>
                    </form>
