...
const Sidebar = ({sidebarOpen, setSidebarOpen}) => {
  ...
  return (
    ...
    justify-between items-center max-sm:abslute top-0 bottom-0 z-20 $
    ...
    transition-all duration-300 ease-in-out`}>
        ...
        justify-between'>
            ...
            <LogOut onClick={signOut} className='w-4.5 h-6 text-gray-400 hover:text-gray-700 transition cursor-pointer'/>
        </div>
    </div>
  )
}
